...
(function() {
  window.Game = {
        ...
        if (this.itemOnScreen(monster) || monster.state === 1) {
          ...
          if (visible && monster.state === 0) {
            ...
            if (visible && Light.on && dist > 40 && (dist < Light.viewRadius)) {
              speed = this.monsterSpeed * (dist / Light.lightValue) / 3;
              angle += 0.5;
            } else {
    ...
    win: function() {
      ...
      Light.addPower();
      return this.say("Thanks, you're a hero!<br>I think I’ll be ok from here :)", 100, 200);
    },
    draw: function() {
    ...
    say: function(msg, holdTime, delay) {
      ...
      setTimeout((function() {
        return el.className = 't fo';
      }), holdTime);
      return setTimeout((function() {
        return o.removeChild(el);
      }), holdTime + 4000 + delay);
    },
    saySoon: function(msg, holdTime, delay) {
